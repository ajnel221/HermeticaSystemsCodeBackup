...
public class DayandNightController : MonoBehaviour
{
    ...
    private void UpdateTime()
    {
        ...
        sky.spaceEmissionTexture.overrideState = enabled;
        sky.spaceEmissionMultiplier.overrideState = enabled;
        sky.spaceEmissionTexture.value = starMap;
