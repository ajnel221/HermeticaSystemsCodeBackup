...
public class PulsatingButtonOptions1 : EventTrigger
{
    ...
    void Start()
    {
        image = GameObject.Find("_UI/Canvas/Pause_Panel/Options");
        arrow = GameObject.Find("_UI/Canvas/Pause_Panel/Options/Image");
    }
