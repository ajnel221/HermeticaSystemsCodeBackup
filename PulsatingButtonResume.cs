...
public class PulsatingButtonResume : EventTrigger
{
    ...
    void Start()
    {
        image = GameObject.Find("_UI/Canvas/Pause_Panel/Resume");
        arrow = GameObject.Find("_UI/Canvas/Pause_Panel/Resume/Image");
    }
